...
Addresses on which the peer is deemed to be reachable by other peers.
For backwards compatibility reasons, implementations MAY include addresses of local interfaces in this list.
